...
### 🐛 Bug Fixes 
- Fix URI formatting when protocol path is empty ([#461](https://github.com/edgexfoundry/device-rest-go/issues/461)) ([#ea8efc1](https://github.com/edgexfoundry/device-rest-go/commits/ea8efc1))
